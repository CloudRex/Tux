...
export default class Google extends Command {
    ...
    async executed(context) {
        let searchMessage = await context.respond("Searching...", "Google", "GRAY", googleThumbnailUrl);
        let searchUrl = `https://www.google.com/search?q=${encodeURIComponent(context.message.content)}`;
